...
public class MixingListView extends TuSdkTableView<MixingCellView.MixingEntity, MixingCellView>
{
	...
	public MixingListView(Context context, AttributeSet attrs, int defStyle)
	{
		super(context, attrs, defStyle);
	}

	public MixingListView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	}
	...
	public void setLongClickDelegate(MixingCellView.MixingCellViewDelegate delegate)
	{
	 ...
	 */
	@Override
	protected void onViewCreated(MixingCellView view, ViewGroup parent, int viewType) 
	{
	 ...
	 */
	@Override
	protected void onViewBinded(MixingCellView view, int position)
	{
	...
	private void updateFilterCellViewStatus(MixingCellView view, Boolean isSelected)
	{
		MixingCellView.MixingEntity model = view.getModel();
			if (isSelected)
			{
