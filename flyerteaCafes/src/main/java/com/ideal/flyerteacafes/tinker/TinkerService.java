...
import com.ideal.flyerteacafes.tinker.module.BasePatch;
...
public class TinkerService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        String path = ApplicationTools.getSDPath() + "/patch_signed.apk";
        TinkerManager.loadPatch(path, FinalUtils.FLYERTEA_MD5_SIGNATURE);
