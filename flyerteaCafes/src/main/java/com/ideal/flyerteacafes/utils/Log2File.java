...
public class Log2File {
    ...
    private static File GetFileFromPath(String path) {
        ...
        if (TextUtils.isEmpty(path)) {
            LogFly.e("Error", "The path of LogFly file is Null.");
            return file;
        }
        ...
        if (isExist) {
            if (isWritable) {
                //LogFly.i("Success", "The LogFly file exist,and can be written! -" + file.getAbsolutePath());
            } else {
                LogFly.e("Error", "The LogFly file can not be written.");
            }
        } else {
            //create the log file
            try {
                ...
                if (ret) {
                    Log.i("Success", "The LogFly file was successfully created! -" + file.getAbsolutePath());
                } else {
                    Log.i("Success", "The LogFly file exist! -" + file.getAbsolutePath());
                }
                ...
                LogFly.e("Error", "Failed to create The LogFly file.");
                e.printStackTrace();
            }
        }
