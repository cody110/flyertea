...
public class OtherMessageAdapter extends CommonAdapter<NotificationBean> {

    public OtherMessageAdapter(Context context, List<NotificationBean> datasAll, int layoutId) {
