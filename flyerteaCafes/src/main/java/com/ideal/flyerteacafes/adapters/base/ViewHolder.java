...
public class ViewHolder {
    ...
    public ViewHolder setText(int viewId, SpannableString sp) {
        TextView tv = getView(viewId);
        tv.setText(sp);
        return this;
    }

    public ViewHolder setText(int viewId, SpannableStringBuilder sp) {
        TextView tv = getView(viewId);
        tv.setText(sp);
        return this;
    }
    ...
    public void setImageUrl(int viewId, String url, int def_img) {
        ImageView view = getView(viewId);
        DataUtils.downloadPicture(view, url, def_img);
    }
    ...
    public ViewHolder setTextSizes(int viewId, int textSize) {
        TextView view = getView(viewId);
