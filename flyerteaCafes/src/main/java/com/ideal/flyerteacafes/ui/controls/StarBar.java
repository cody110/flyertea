...
public class StarBar extends View {
    ...
    private Paint emptyPaint;//暗星星
    private boolean integerMark = false;
    private boolean clickMark = true;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.starEmptyBitmap = drawableToBitmap(mTypedArray.getDrawable(R.styleable.RatingBar_starEmpty));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < starCount; i++) {
            canvas.drawRect(0, 0, starSize, starSize, emptyPaint);
