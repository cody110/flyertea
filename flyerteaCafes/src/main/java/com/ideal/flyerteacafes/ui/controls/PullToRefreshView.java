...
public class PullToRefreshView extends LinearLayout {
    ...
    private boolean isNeed_pull_down = true;
    ...
    private String pull_to_refresh_release_label = getContext().getString(R.string.pull_to_refresh_release_label);
    private String pull_to_refresh_pull_label = getContext().getString(R.string.pull_to_refresh_pull_label);
    private String pull_to_refresh_refreshing_label = getContext().getString(R.string.pull_to_refresh_refreshing_label);


    public void setPull_to_refresh_release_label(String pull_to_refresh_release_label) {
        this.pull_to_refresh_release_label = pull_to_refresh_release_label;
    }

    public void setPull_to_refresh_pull_label(String pull_to_refresh_pull_label) {
        this.pull_to_refresh_pull_label = pull_to_refresh_pull_label;
    }

    public void setPull_to_refresh_refreshing_label(String pull_to_refresh_refreshing_label) {
        this.pull_to_refresh_refreshing_label = pull_to_refresh_refreshing_label;
    }
     ...
     * @param bol
     */
    public void setNeed_pull_down(boolean bol) {
        isNeed_pull_down = bol;
    }
    ...
    int d_x = 0, d_y = 0, m_x, m_y;
    int compute = DensityUtil.dip2px(10);
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                int dis_x = Math.abs(d_x - m_x);
                int dis_y = Math.abs(d_y - m_y);

                //横向滑动距离大于纵向不拦截
                if (dis_x > dis_y) return false;
                ...
                //TODO 下拉刷新 不需要就不拦截
                if (!isNeed_pull_down && deltaY > 0) return false;
    ...
    private void headerPrepareToRefresh(int deltaY) {
        ...
        if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
            mHeaderTextView.setText(pull_to_refresh_release_label);
            ...
            mHeaderImageView.startAnimation(mFlipAnimation);
            // mHeaderImageView.
            mHeaderTextView.setText(pull_to_refresh_pull_label);
    ...
    public void headerRefreshing() {
        ...
        mHeaderProgressBar.startAnimation(progressAnimation);
        mHeaderTextView.setText(pull_to_refresh_refreshing_label);
    ...
    private void footerRefreshing() {
        ...
        mFooterProgressBar.startAnimation(progressAnimation);
        mFooterTextView
    ...
    public void onHeaderRefreshComplete() {
        ...
        mHeaderImageView.setImageResource(R.mipmap.tableview_pull_refresh_arrow_down);
    ...
    public void onFooterRefreshComplete() {
        ...
        mFooterImageView.setImageResource(R.mipmap.tableview_pull_refresh_arrow_up);
        mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
