        ...
        switch (ev.getAction() & ev.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mDragStarted) {
                    ...
                    if (position != AdapterView.INVALID_POSITION && !((GridViewSortAdapter) getAdapter()).isInAnimation() && position >= moveNum) {
