...
public class PullToRefreshView2 extends LinearLayout {
     ...
     */
    private OnFooterRefreshListener2 mOnFooterRefreshListener;
    /**
     * footer refresh listener
     */
    private OnHeaderRefreshListener2 mOnHeaderRefreshListener;

    /**
     * last update time
     */
    // private String mLastUpdateTime;
    public PullToRefreshView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(deltaY> DensityUtil.dip2px(20)||deltaY<DensityUtil.dip2px(-20)) {
    ...
    public void setOnHeaderRefreshListener(
            OnHeaderRefreshListener2 headerRefreshListener) {
        mOnHeaderRefreshListener = headerRefreshListener;
    }

    public void setOnFooterRefreshListener(
            OnFooterRefreshListener2 footerRefreshListener) {
     ...
     */
    public interface OnFooterRefreshListener2 {
     ...
     * view should be refreshed.
     */
    public interface OnHeaderRefreshListener2 {
