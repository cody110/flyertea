 ...
 */
package com.ideal.flyerteacafes.ui.view.seekbar;
...
public class SeekBarPressure extends View {
    ...
    /*
     * private static login_bg int[] PRESSED_STATE_SET = {
...
//        this.setBackgroundColor(Color.BLACK);
        ...
        notScrollBarBg = resources.getDrawable(R.drawable.seekbar_not_choose);
        hasScrollBarBg = resources.getDrawable(R.drawable.seekbar_choose);
